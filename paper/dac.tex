...
Figure. \ref{fig:power_plant} shows the typical service chain in a Thermal power plant. Chains usually start with big controllers, like the Boiler Management System (BMS) and propagate to various sub-components. If the pressure sensor mounted on a boiler detects an abnormal steam pressure, that event in conveyed to the Controller, which in turn invokes the complete chain of services.
